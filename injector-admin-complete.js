            ...
            modal.innerHTML = `
                <<div class="modal-content" style="max-width: 1200px; width: 95vw; max-height: 90vh; overflow-y: auto; overflow-x: hidden;">
                 ...
                 <style>
                    ...
                    .player-inputs {
                        display: grid;
                        grid-template-columns: 100px 60px 50px;
                        gap: 5px;
                        margin-bottom: 10px;
                    }
                    .player-attributes {
            ...
            container.innerHTML = this.squadPlayers.map((player, index) => `
                <div class="player-card">
                    <div class="player-card-header">
                        ...
                        <button class="btn" style="background: #c73446; padding: 1px 3px; font-size: 0.6rem;" onclick="window.adminBackend.removePlayer(${index})">🗑️</button>
                    </div>
